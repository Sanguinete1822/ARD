...
while player_damage < 1 and pc_damage < 1:
    ...
    if player_choice == 'shoot' and player_ammunition > 0 and pc_choice != 'def':
        if pc_choice != 'shoot' or pc_ammunition < 1:
            pc_damage = + 1
#aqui :if pc_choice != 'shoot' or pc_ammunition < 1
            print("CPU perdeu... Você ganhou!!")
    elif player_choice == 'shoot' and player_ammunition < 1:
        print("-Sem munição")
    ...
    if pc_choice == 'shoot' and pc_ammunition > 0 and player_choice != 'def':
        if player_choice != 'shoot' or player_ammunition < 1:
            player_damage = + 1
#e aqui :if player_choice != 'shoot' or player_ammunition < 1
            print("CPU ganhou!! Você perdeu...")
    elif pc_choice == 'shoot' and pc_ammunition < 1:
        print(f"-Sem munição")
