...
def jogar(escolha):
    ...
    if escolha == 'atirar':
        if plam > 0 and cpuam > 0:
            plays = ['defender'] * 14 + ['recarregar'] * 1 + ['atirar'] * 3
        elif plam > 0 and cpuam == 0:
            plays = ['defender'] * 14 + ['recarregar'] * 3 + ['atirar'] * 1
        elif plam == 0 and cpuam > 0:
            plays = ['defender'] * 1 + ['recarregar'] * 3 + ['atirar'] * 14
        elif plam == 0 and cpuam == 0:
            plays = ['defender'] * 3 + ['recarregar'] * 14 + ['atirar'] * 1
